...
export class LoginComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private router: Router, private authService: AuthService, private permissioneService : NgxPermissionsService) { }

  
  ngOnInit() {
    const permissions = ['allguide','addguida', 'testguida1']
this.permissioneService.loadPermissions(permissions) 
this.permissioneService.loadPermissions(permissions, (permissionName, permissionStore) => {
